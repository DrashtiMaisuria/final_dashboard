    ...
    mainPanel(
      tabsetPanel(
        tabPanel("Dashboard",
                 ...
                 p("Key Takeaways: This line graph shows the relationship between the average square footage and crime rate in the top 10 most crime-heavy zip codes."),
                 plotlyOutput("linePlotLeast"),
                 p("Key Takeaways: This line graph illustrates the contrast between the average square footage and crime rates in the top 10 least crime-heavy zip codes."),
                 br(),
                 h4("Real-World Importance"),
                 p("This dashboard provides insight into how housing characteristics and crime rates interact, helping users understand affordability and safety across zip codes. The findings can support informed decision-making for prospective homebuyers, policymakers, and urban planners focused on equitable housing access."),
                 br(),
                 p("View the source code on ", 
                   a("GitHub", href = "https://github.com/DrashtiMaisuria/final_dashboard", target = "_blank"), 
                   ".")
        ),
        tabPanel("Dataset Description",
                 h3("About the Dataset"),
                 p(HTML("This dashboard uses the publicly available <a href='https://www.kaggle.com/datasets' target='_blank'>USA Housing Dataset from Kaggle</a>.")),
                 p("The dataset contains 300 observations and 10 variables, including price, square footage, crime rate, school rating, and zip code."),
                 p("Data was compiled from multiple publicly available housing-related sources, and zip codes were randomly generated."),
                 p("The dataset reflects properties from across the United States, updated most recently in January 2025."),
                 p("The study focuses on residential properties and their surrounding socioeconomic factors.")
        )
      )
    )
  )
